        ...
        <div className="container-fluid p-0">
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <button
                    ...
                    onClick={() => { setShowModal(true); setEditId(null); setFormData({ lockerNumber: "", size: "medium", location: "", status: "available" }) }}
                        ...
                        <div className="modal-content" style={{ backgroundColor: "#1e293b", color: "#f8fafc", border: "1px solid #334155" }}>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="modal-body">
                                    <div className="mb-3">
                                        <label className="form-label small text-uppercase" style={{ color: '#cbd5e1' }}>Locker Number</label>
                                        <input
                                            type="text"
